...
|---|---|---|---|
| **v2.8.3** | 2026-09-17 | `-` | **(TERKINI)** Pertanyaan puzzle kini diatur per event (`pzPrompt`, isi di builder). Event HKA: **"1 Kata Untuk Astra"** — tampil besar di form HP & di kartu QR layar utama; input jadi satu baris pendek (maks 60 huruf); jawaban pendek muncul besar di popup agar terbaca dari jauh; kolom Excel mengikuti pertanyaan. |
