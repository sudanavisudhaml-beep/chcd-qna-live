...
|---|---|---|---|
| **v2.6** | 2026-07-20 | `-` | **(TERKINI)** **Ripple di semua halaman.** Efek sonar dari ikon Q kini juga tampil di logo QUERY pada landing, dashboard, dan hero setiap sesi (Q&A/kuesioner/vote) — varian **ring biru Astra** (`.qripple.qblue`) karena halaman-halaman itu berlatar terang; layar live tetap ring putih. Wrapper `.qlogo-wrap` menjaga pusat ripple tepat di ikon Q. |
