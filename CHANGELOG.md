...
|---|---|---|---|
| **v2.7** | 2026-07-21 | `-` | **(TERKINI)** **Link "Lihat Hasil" read-only untuk dibagikan.** Route baru `#/r/CODE` menampilkan halaman Hasil kuesioner ke siapa pun (atasan) **tanpa login & tanpa masuk form** — kontrol pemilik (Edit/Reset) disembunyikan, Export CSV tetap ada. Di halaman Hasil host ada tombol **🔗 Bagikan Hasil ke Atasan** (link + QR + salin). Catatan: siapa pun yang punya link bisa melihat. |
