...
|---|---|---|---|
| **v2.8.1** | 2026-09-16 | `-` | **(TERKINI)** Puzzle: jumlah keping kini bisa sampai **40×40** — preset cepat (24/80/192/400) + input manual kolom×baris dengan peringatan bila keping banyak (butuh banyak peserta / pakai Ungkap Semua). Event HKA di-set ke 400 keping (25×16). |
