...
|---|---|---|---|
| **v2.8.2** | 2026-09-17 | `-` | **(TERKINI)** Puzzle HKA siap acara: gambar teaser asli terpasang (dikompres 1920×1080, nama acak); jarak kisi mengecil otomatis di keping banyak (1px di 400 keping, sebelumnya 3px menutupi gambar); QR bisa pakai file statis di situs sendiri (`qrImg`) dengan layanan luar sebagai cadangan, agar tak bergantung pihak ketiga di Wi-Fi venue; judul kartu QR puzzle "SCAN & TULIS TESTIMONI". |
